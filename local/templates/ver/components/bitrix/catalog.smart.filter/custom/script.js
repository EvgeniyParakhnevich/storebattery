...
$(window).on("load", function() {
	...
	// 	var $this = $(this);
	// 	$this.toggleClass("expanded").parent().siblings(".params").toggleClass("collapsed");
	// });

	$(".paramsBoxTitle").on("click", function(){
		// var $this = $(this).parents(".paramsBoxTitle");
		var $this = $(this);
		$this.find(".propExpander").toggleClass("expanded").parent(".paramsBoxTitle").siblings(".params").toggleClass("collapsed");
	});
